    ...
    <>
      ...
      <div className={styles.topnav}>
        ...
        <div className={styles.navlinks}>
          ...
          <a href="https://www.sahalatsolutions.com/" target="_blank">sahalatsolutions</a>
        </div>
      </div>
      <main className={styles.main}>
            ...
            {messages.map((message, index) => {
              return (
                ...
                <div key={index} className={message.role === "user" && loading && index === messages.length - 1 ? styles.usermessagewaiting : message.role === "assistant" ? styles.apimessage : styles.usermessage}>
                  ...
                  {message.role === "assistant" ? <Image src="/salogon.png" alt="AI" width="30" height="30" className={styles.boticon} priority={true} /> : <Image src="/usericon.png" alt="Me" width="30" height="30" className={styles.usericon} priority={true} />}
        ...
        <div className={styles.center}>
          ...
          <div className={styles.footer}>
            <p>Powered by <a href="https://openai.com/" target="_blank">OpenAI</a>. Built on <a href="https://www.sahalatsolutions.com/" target="_blank">sahalat</a>.</p>
          </div>
        </div>
      </main>
    </>
